...
equation
  ...
  connect(inertia.flange_b, dogClutch5_1.input_shaft)
    annotation (Line(points={{-40,0},{-10,0}}, color={0,0,0}));
  connect(dogClutch5_1.fork, mass.flange_b)
    annotation (Line(points={{0,10},{0,40}}, color={0,127,0}));
  connect(dogClutch5_1.output_shaft, inertia2.flange_a)
